...
//무조건 컨트롤을 통해서만 데이터를 보여주고 처리해야 한다

public class MemoView {
	public void init(MemoController controller) throws Exception { //메뉴가뜨게만들어줌
	...
	Program: while(true) {
		...
		case 3:
			...
			int searchId = Integer.parseInt(scanner.nextLine()); // 서치할아이디를 입력받으면 아이디가 있는지없는지 판별.
